    ...
    <section>
      ...
      <div className="mb-8">
        ...
        <p className="mb-6 text-neutral-700 dark:text-neutral-300">
          ...
          in 3D imaging and computer graphics. This website serves as a portfolio of my projects.
        </p>

        <h2 className="text-xl font-medium mb-3 tracking-tight">Professional Experience &amp; Philosophy</h2>
        <p className="mb-6 text-neutral-700 dark:text-neutral-300">
          Throughout my career, I have been instrumental in building and maintaining backend systems
          powering services for over 16 million monthly active users. This involved ensuring high availability,
          scalability, and performance for high-traffic environments. I have a strong commitment to user-centric design, ensuring seamless and positive
        ...
        <p className="mb-6 text-neutral-700 dark:text-neutral-300">
          ...
          distributed computing for computer-generated holograms, graphics APIs, and parallel computing.
        </p>
